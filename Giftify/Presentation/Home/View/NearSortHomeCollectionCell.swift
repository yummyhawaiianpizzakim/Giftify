//
//  NearSortHomeCollectionCell.swift
//  Giftify
//
...
class NearSortHomeCollectionCell: UICollectionViewCell {
    static var id: String {
        return "NearSortHomeCollectionCell"
    }
...
private extension NearSortHomeCollectionCell {
    func configureUI() {
...
extension NearSortHomeCollectionCell {
